...
'''
2. Multiple time series slices (1)
...
'''
3. Multiple time series slices (2)
...
'''
6. Plotting moving standard deviations
...
'''
7. Extracting a histogram from a grayscale image
...
'''
8. Cumulative Distribution Function from an image histogram
...
'''
9. Equalizing an image histogram
...
'''
10. Extracting histograms from a color image
...
'''
11. Extracting bivariate histograms from a color image
